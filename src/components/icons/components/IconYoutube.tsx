...
const IconYoutube = (props: React.HTMLAttributes<SVGElement> /*#__PURE__*/) =>
    React.createElement(
        'svg',
        {
            ...props,
        ...
        /*#__PURE__*/ React.createElement('path', {
            fill: 'url(#3hXF6bmA1hdaWqDtRL46ua)',
